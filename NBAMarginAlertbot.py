...
bot.set_webhook(url="https://vercel.com/yareds-projects-504c1b96/") #vercel url
...
async def telegram_webhook(update: TelegramWebhook):
    ...
    bot.process_new_updates([telebot.types.Update.de_json(update_dict)])
...
async def monitor_games(chat_id, team_names):
